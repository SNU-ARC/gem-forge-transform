/*
 * [ARC-SJ] Greedy search of in-memory search algorithm
 * Based on SSG implementation (+ ADA-NNS)
 */
...
int main(int argc, char** argv) {
  ...
  std::cout << "SSG Path: " << argv[3] << std::endl;
  ...
  std::cout << "hash_function_name: " << hash_function_name << std::endl;
  std::cout << "hashed_set_name: " << hashed_set_name  << std::endl;
