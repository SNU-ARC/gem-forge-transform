...
static const uint64_t num_node			  = 22499;
static const uint64_t num_edge_hvd        = 43858; 
...
static const uint64_t nonzero             = 2*num_edge_hvd;
...
int main(int argc, char **argv) {
  ...
  // indx from file
  FILE* fp_mtx = fopen("../dataset/graph/cs4/cs4_rows.dat", "rb");
  ...
  if (fp_mtx != NULL) {
    ...
    printf("Cannot find cs4_row.dat\n");
    return 0;
  }
  ...
  // pntrb from file
  FILE* fp_mtx2 = fopen("../dataset/graph/cs4/cs4_pntrb.dat", "rb");
  ...
  if (fp_mtx2 != NULL) {
    ...
    printf("Cannot find cs4_pntrb.dat\n");
    return 0;
  }

  // pntre from file
  FILE* fp_mtx3 = fopen("../dataset/graph/cs4/cs4_pntre.dat", "rb");
  ...
  if (fp_mtx3 != NULL) {
    ...
    printf("Cannot find cs4_pntre.dat\n");
    return 0;
  }
  ...
  // b from file
  FILE* fp_mtx4 = fopen("../dataset/graph/cs4/cs4_b_mat.dat", "rb");
  ...
  if (fp_mtx4 != NULL) {
    ...
    printf("Cannot find cs4_b_mat.dat\n");
    return 0;
  }
  ...
  // val from file
  FILE* fp_mtx5 = fopen("../dataset/graph/cs4/cs4_val.dat", "rb");
  ...
  if (fp_mtx5 != NULL) {
    ...
    printf("Cannot find cs4_val.dat\n");
    return 0;
  }
